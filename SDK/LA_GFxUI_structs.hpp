...
struct FASValue
{
	...
	uint32_t                                           B : 1;                                                    // 0x0004(0x0004) (Edit)
...
struct FASDisplayInfo
{
	...
	uint32_t                                           Visible : 1;                                              // 0x0028(0x0004) (Edit)
	uint32_t                                           hasX : 1;                                                 // 0x0028(0x0004) (Edit)
	uint32_t                                           hasY : 1;                                                 // 0x0028(0x0004) (Edit)
	uint32_t                                           hasZ : 1;                                                 // 0x0028(0x0004) (Edit)
	uint32_t                                           hasRotation : 1;                                          // 0x0028(0x0004) (Edit)
	uint32_t                                           hasXRotation : 1;                                         // 0x0028(0x0004) (Edit)
	uint32_t                                           hasYRotation : 1;                                         // 0x0028(0x0004) (Edit)
	uint32_t                                           hasXScale : 1;                                            // 0x0028(0x0004) (Edit)
	uint32_t                                           hasYScale : 1;                                            // 0x0028(0x0004) (Edit)
	uint32_t                                           hasZScale : 1;                                            // 0x0028(0x0004) (Edit)
	uint32_t                                           hasAlpha : 1;                                             // 0x0028(0x0004) (Edit)
	uint32_t                                           hasVisible : 1;                                           // 0x0028(0x0004) (Edit)
};
