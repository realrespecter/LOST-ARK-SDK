...
enum class EPrimitveLookType : uint8_t
{
	...
	EPrimitiveLook_Others          = 5,
	EPrimitiveLook_MAX             = 6
};
...
struct FTimerData
{
	uint32_t                                           bLoop : 1;                                                // 0x0000(0x0004)
	uint32_t                                           bPaused : 1;                                              // 0x0000(0x0004)
...
struct FWorldFractureSettings
{
	...
	uint32_t                                           bEnableChanceOfPhysicsChunkOverride : 1;                  // 0x0004(0x0004)
	uint32_t                                           bLimitExplosionChunkSize : 1;                             // 0x0004(0x0004)
	float                                              MaxExplosionChunkSize;                                    // 0x0008(0x0004)
	uint32_t                                           bLimitDamageChunkSize : 1;                                // 0x000C(0x0004)
...
struct FMusicTrackStruct
{
	...
	uint32_t                                           bAutoPlay : 1;                                            // 0x0008(0x0004) (Edit)
	uint32_t                                           bPersistentAcrossLevels : 1;                              // 0x0008(0x0004) (Edit)
...
struct FLUTBlender
{
	...
	uint32_t                                           bHasChanged : 1;                                          // 0x0020(0x0004) (Const, Native, Transient)
};
...
{
	uint32_t                                           bOverride_Mobile_BlurAmount : 1;                          // 0x0000(0x0004)
	uint32_t                                           bOverride_Mobile_TransitionTime : 1;                      // 0x0000(0x0004)
	uint32_t                                           bOverride_Mobile_Bloom_Scale : 1;                         // 0x0000(0x0004)
	uint32_t                                           bOverride_Mobile_Bloom_Threshold : 1;                     // 0x0000(0x0004)
	uint32_t                                           bOverride_Mobile_Bloom_Tint : 1;                          // 0x0000(0x0004)
	uint32_t                                           bOverride_Mobile_DOF_Distance : 1;                        // 0x0000(0x0004)
	uint32_t                                           bOverride_Mobile_DOF_MinRange : 1;                        // 0x0000(0x0004)
	uint32_t                                           bOverride_Mobile_DOF_MaxRange : 1;                        // 0x0000(0x0004)
	uint32_t                                           bOverride_Mobile_DOF_FarBlurFactor : 1;                   // 0x0000(0x0004)
...
{
	uint32_t                                           bOverride_EnableBloom : 1;                                // 0x0000(0x0004)
	uint32_t                                           bOverride_EnableDOF : 1;                                  // 0x0000(0x0004)
	uint32_t                                           bOverride_EnableMotionBlur : 1;                           // 0x0000(0x0004)
	uint32_t                                           bOverride_EnableSceneEffect : 1;                          // 0x0000(0x0004)
	uint32_t                                           bOverride_AllowAmbientOcclusion : 1;                      // 0x0000(0x0004)
	uint32_t                                           bOverride_OverrideRimShaderColor : 1;                     // 0x0000(0x0004)
	uint32_t                                           bOverride_Bloom_Scale : 1;                                // 0x0000(0x0004)
	uint32_t                                           bOverride_Bloom_Threshold : 1;                            // 0x0000(0x0004)
	uint32_t                                           bOverride_Bloom_Tint : 1;                                 // 0x0000(0x0004)
	uint32_t                                           bOverride_Bloom_ScreenBlendThreshold : 1;                 // 0x0000(0x0004)
	uint32_t                                           bOverride_Bloom_InterpolationDuration : 1;                // 0x0000(0x0004)
	uint32_t                                           bOverride_DOF_FalloffExponent : 1;                        // 0x0000(0x0004)
	uint32_t                                           bOverride_DOF_BlurKernelSize : 1;                         // 0x0000(0x0004)
	uint32_t                                           bOverride_DOF_BlurBloomKernelSize : 1;                    // 0x0000(0x0004)
	uint32_t                                           bOverride_DOF_MaxNearBlurAmount : 1;                      // 0x0000(0x0004)
	uint32_t                                           bOverride_DOF_MinBlurAmount : 1;                          // 0x0000(0x0004)
	uint32_t                                           bOverride_DOF_MaxFarBlurAmount : 1;                       // 0x0000(0x0004)
	uint32_t                                           bOverride_DOF_FocusType : 1;                              // 0x0000(0x0004)
	uint32_t                                           bOverride_DOF_FocusInnerRadius : 1;                       // 0x0000(0x0004)
	uint32_t                                           bOverride_DOF_FocusDistance : 1;                          // 0x0000(0x0004)
	uint32_t                                           bOverride_DOF_FocusPosition : 1;                          // 0x0000(0x0004)
	uint32_t                                           bOverride_DOF_InterpolationDuration : 1;                  // 0x0000(0x0004)
	uint32_t                                           bOverride_DOF_BokehTexture : 1;                           // 0x0000(0x0004)
	uint32_t                                           bOverride_MotionBlur_MaxVelocity : 1;                     // 0x0000(0x0004)
	uint32_t                                           bOverride_MotionBlur_Amount : 1;                          // 0x0000(0x0004)
	uint32_t                                           bOverride_MotionBlur_FullMotionBlur : 1;                  // 0x0000(0x0004)
	uint32_t                                           bOverride_MotionBlur_CameraRotationThreshold : 1;         // 0x0000(0x0004)
	uint32_t                                           bOverride_MotionBlur_CameraTranslationThreshold : 1;      // 0x0000(0x0004)
	uint32_t                                           bOverride_MotionBlur_InterpolationDuration : 1;           // 0x0000(0x0004)
	uint32_t                                           bOverride_Scene_Desaturation : 1;                         // 0x0000(0x0004)
	uint32_t                                           bOverride_Scene_Colorize : 1;                             // 0x0000(0x0004)
	uint32_t                                           bOverride_Scene_TonemapperScale : 1;                      // 0x0000(0x0004)
	uint32_t                                           bOverride_Scene_TonemapperRange : 1;                      // 0x0004(0x0004)
	uint32_t                                           bOverride_Scene_TonemapperToeFactor : 1;                  // 0x0004(0x0004)
	uint32_t                                           bOverride_Scene_ImageGrainScale : 1;                      // 0x0004(0x0004)
	uint32_t                                           bOverride_Scene_HighLights : 1;                           // 0x0004(0x0004)
	uint32_t                                           bOverride_Scene_MidTones : 1;                             // 0x0004(0x0004)
	uint32_t                                           bOverride_Scene_Shadows : 1;                              // 0x0004(0x0004)
	uint32_t                                           bOverride_Scene_InterpolationDuration : 1;                // 0x0004(0x0004)
	uint32_t                                           bOverride_Scene_ColorGradingLUT : 1;                      // 0x0004(0x0004)
	uint32_t                                           bOverride_RimShader_Color : 1;                            // 0x0004(0x0004)
	uint32_t                                           bOverride_RimShader_InterpolationDuration : 1;            // 0x0004(0x0004)
	uint32_t                                           bOverride_AmbientOcclusion_OcclusionScale : 1;            // 0x0004(0x0004)
	uint32_t                                           bOverride_AmbientOcclusion_OcclusionPower : 1;            // 0x0004(0x0004)
	uint32_t                                           bOverride_AmbientOcclusion_InterpolationDuration : 1;     // 0x0004(0x0004)
	uint32_t                                           bOverride_MobileColorGrading : 1;                         // 0x0004(0x0004)
	uint32_t                                           bEnableBloom : 1;                                         // 0x0004(0x0004) (Edit)
	uint32_t                                           bEnableDOF : 1;                                           // 0x0004(0x0004) (Edit)
	uint32_t                                           bEnableMotionBlur : 1;                                    // 0x0004(0x0004) (Edit)
	uint32_t                                           bEnableSceneEffect : 1;                                   // 0x0004(0x0004) (Edit)
	uint32_t                                           bAllowAmbientOcclusion : 1;                               // 0x0004(0x0004) (Edit)
	uint32_t                                           bOverrideRimShaderColor : 1;                              // 0x0004(0x0004) (Edit)
	...
	uint32_t                                           MotionBlur_FullMotionBlur : 1;                            // 0x0060(0x0004) (Edit)
...
{
	uint32_t                                           bApplyReverb : 1;                                         // 0x0000(0x0004) (Edit)
...
{
	uint32_t                                           bIsWorldInfo : 1;                                         // 0x0000(0x0004)
...
{
	uint32_t                                           bUseHardware : 1;                                         // 0x0000(0x0004) (Edit)
	uint32_t                                           bFixedTimeStep : 1;                                       // 0x0000(0x0004) (Edit)
...
{
	uint32_t                                           RigidBody : 1;                                            // 0x0000(0x0004) (Edit)
	uint32_t                                           Fluid : 1;                                                // 0x0000(0x0004) (Edit)
	uint32_t                                           Cloth : 1;                                                // 0x0000(0x0004) (Edit)
	uint32_t                                           SoftBody : 1;                                             // 0x0000(0x0004) (Edit)
};
...
struct FApexModuleDestructibleSettings
{
	...
	uint32_t                                           bOverrideMaxChunkSeparationLOD : 1;                       // 0x0010(0x0004) (Edit)
};
...
{
	uint32_t                                           bDisableLod : 1;                                          // 0x0000(0x0004) (Edit)
	...
	uint32_t                                           bApplyCylindricalPacketCulling : 1;                       // 0x0010(0x0004) (Edit)
...
struct FLightmassWorldInfoSettings
{
	...
	uint32_t                                           bEnableAdvancedEnvironmentColor : 1;                      // 0x0010(0x0004) (Edit)
	...
	uint32_t                                           bUseAmbientOcclusion : 1;                                 // 0x003C(0x0004) (Edit)
	uint32_t                                           bEnableImageReflectionShadowing : 1;                      // 0x003C(0x0004) (Edit)
	...
	uint32_t                                           bVisualizeMaterialDiffuse : 1;                            // 0x0054(0x0004) (Edit)
	uint32_t                                           bVisualizeAmbientOcclusion : 1;                           // 0x0054(0x0004) (Edit)
	uint32_t                                           bCompressShadowmap : 1;                                   // 0x0054(0x0004) (Edit)
};
...
struct FHostMigrationState
{
	...
	uint32_t                                           bHostMigrationEnabled : 1;                                // 0x001C(0x0004)
};
...
struct FOnlineContent
{
	...
	uint32_t                                           bIsCorrupt : 1;                                           // 0x0004(0x0004)
...
struct FStatColorMapping
{
	...
	uint32_t                                           DisableBlend : 1;                                         // 0x0020(0x0004) (Config, GlobalConfig)
};
...
struct FLevelStreamingStatus
{
	...
	uint32_t                                           bShouldBeLoaded : 1;                                      // 0x0008(0x0004)
	uint32_t                                           bShouldBeVisible : 1;                                     // 0x0008(0x0004)
};
...
struct ADynamicBlockingVolume_FCheckpointRecord
{
	struct FVector                                     Location;                                                 // 0x0000(0x000C)
	struct FRotator                                    Rotation;                                                 // 0x000C(0x000C)
	uint32_t                                           bCollideActors : 1;                                       // 0x0018(0x0004)
	uint32_t                                           bBlockActors : 1;                                         // 0x0018(0x0004)
	uint32_t                                           bNeedsReplication : 1;                                    // 0x0018(0x0004)
};
...
{
	uint32_t                                           bDisabled : 1;                                            // 0x0000(0x0004)
};
...
{
	uint32_t                                           bPainCausing : 1;                                         // 0x0000(0x0004)
	uint32_t                                           bActive : 1;                                              // 0x0000(0x0004)
};
...
struct AInterpActor_FCheckpointRecord
{
	...
	uint32_t                                           bHidden : 1;                                              // 0x001C(0x0004)
	uint32_t                                           bIsShutdown : 1;                                          // 0x001C(0x0004)
	uint32_t                                           bNeedsPositionReplication : 1;                            // 0x001C(0x0004)
};
...
{
	uint32_t                                           bIsActive : 1;                                            // 0x0000(0x0004)
};
...
struct FEmitterBaseInfo
{
	...
	uint32_t                                           bInheritBaseScale : 1;                                    // 0x0028(0x0004)
};
...
{
	uint32_t                                           bEnableGlow : 1;                                          // 0x0000(0x0004)
...
{
	uint32_t                                           bClipText : 1;                                            // 0x0000(0x0004)
	uint32_t                                           bEnableShadow : 1;                                        // 0x0000(0x0004)
...
struct FHudLocalizedMessage
{
	...
	uint32_t                                           Drawn : 1;                                                // 0x0040(0x0004)
...
struct FGameTypePrefix
{
	...
	uint32_t                                           bUsesCommonPackage : 1;                                   // 0x0010(0x0004)
...
{
	uint32_t                                           bDisabled : 1;                                            // 0x0000(0x0004)
	uint32_t                                           bBlocked : 1;                                             // 0x0000(0x0004)
};
...
struct FFireLink
{
	...
	uint32_t                                           bFallbackLink : 1;                                        // 0x0014(0x0004)
	uint32_t                                           bDynamicIndexInited : 1;                                  // 0x0014(0x0004)
};
...
struct FCoverSlot
{
	...
	uint32_t                                           bLeanLeft : 1;                                            // 0x008C(0x0004) (Edit)
	uint32_t                                           bLeanRight : 1;                                           // 0x008C(0x0004) (Edit)
	uint32_t                                           bForceCanPopUp : 1;                                       // 0x008C(0x0004) (Edit)
	uint32_t                                           bCanPopUp : 1;                                            // 0x008C(0x0004) (Edit, EditConst)
	uint32_t                                           bCanMantle : 1;                                           // 0x008C(0x0004) (Edit, EditConst)
	uint32_t                                           bCanClimbUp : 1;                                          // 0x008C(0x0004) (Edit, EditConst)
	uint32_t                                           bForceCanCoverSlip_Left : 1;                              // 0x008C(0x0004) (Edit)
	uint32_t                                           bForceCanCoverSlip_Right : 1;                             // 0x008C(0x0004) (Edit)
	uint32_t                                           bCanCoverSlip_Left : 1;                                   // 0x008C(0x0004) (Edit, EditConst)
	uint32_t                                           bCanCoverSlip_Right : 1;                                  // 0x008C(0x0004) (Edit, EditConst)
	uint32_t                                           bCanSwatTurn_Left : 1;                                    // 0x008C(0x0004) (Edit, EditConst)
	uint32_t                                           bCanSwatTurn_Right : 1;                                   // 0x008C(0x0004) (Edit, EditConst)
	uint32_t                                           bEnabled : 1;                                             // 0x008C(0x0004) (Edit)
	uint32_t                                           bAllowPopup : 1;                                          // 0x008C(0x0004) (Edit)
	uint32_t                                           bAllowMantle : 1;                                         // 0x008C(0x0004) (Edit)
	uint32_t                                           bAllowCoverSlip : 1;                                      // 0x008C(0x0004) (Edit)
	uint32_t                                           bAllowClimbUp : 1;                                        // 0x008C(0x0004) (Edit)
	uint32_t                                           bAllowSwatTurn : 1;                                       // 0x008C(0x0004) (Edit)
	uint32_t                                           bForceNoGroundAdjust : 1;                                 // 0x008C(0x0004) (Edit)
	uint32_t                                           bPlayerOnly : 1;                                          // 0x008C(0x0004) (Edit)
	uint32_t                                           bPreferLeanOverPopup : 1;                                 // 0x008C(0x0004) (Edit)
	uint32_t                                           bDestructible : 1;                                        // 0x008C(0x0004) (Transient)
	uint32_t                                           bSelected : 1;                                            // 0x008C(0x0004) (Transient)
	uint32_t                                           bFailedToFindSurface : 1;                                 // 0x008C(0x0004) (Edit, Transient, EditConst)
};
...
struct FKSphereElem : public FKColElemBase
{
	...
	uint32_t                                           bNoRBCollision : 1;                                       // 0x0054(0x0004) (Edit)
	uint32_t                                           bPerPolyShape : 1;                                        // 0x0054(0x0004) (Edit)
};
...
struct FKBoxElem : public FKColElemBase
{
	...
	uint32_t                                           bNoRBCollision : 1;                                       // 0x005C(0x0004) (Edit)
	uint32_t                                           bPerPolyShape : 1;                                        // 0x005C(0x0004) (Edit)
};
...
struct FKSphylElem : public FKColElemBase
{
	...
	uint32_t                                           bNoRBCollision : 1;                                       // 0x0058(0x0004) (Edit)
	uint32_t                                           bPerPolyShape : 1;                                        // 0x0058(0x0004) (Edit)
};
...
struct FKAggregateGeom
{
	...
	uint32_t                                           bSkipCloseAndParallelChecks : 1;                          // 0x0048(0x0004) (Edit)
};
...
{
	uint32_t                                           bCollideActors : 1;                                       // 0x0000(0x0004)
};
...
struct FMultiCueSplineSoundSlot
{
	...
	uint32_t                                           bPlaying : 1;                                             // 0x0030(0x0004)
};
...
{
	uint32_t                                           bInitialized : 1;                                         // 0x0000(0x0004)
	uint32_t                                           BSP : 1;                                                  // 0x0000(0x0004) (Edit)
	uint32_t                                           Static : 1;                                               // 0x0000(0x0004) (Edit)
	uint32_t                                           Dynamic : 1;                                              // 0x0000(0x0004) (Edit)
	uint32_t                                           CompositeDynamic : 1;                                     // 0x0000(0x0004) (Edit)
	uint32_t                                           Skybox : 1;                                               // 0x0000(0x0004) (Edit)
	uint32_t                                           Unnamed_2 : 1;                                            // 0x0000(0x0004) (Edit)
	uint32_t                                           Unnamed_3 : 1;                                            // 0x0000(0x0004) (Edit)
	uint32_t                                           Unnamed_4 : 1;                                            // 0x0000(0x0004) (Edit)
	uint32_t                                           Unnamed_5 : 1;                                            // 0x0000(0x0004) (Edit)
	uint32_t                                           Unnamed_6 : 1;                                            // 0x0000(0x0004) (Edit)
	uint32_t                                           Unnamed_7 : 1;                                            // 0x0000(0x0004) (Edit)
	uint32_t                                           Cinematic_2 : 1;                                          // 0x0000(0x0004) (Edit)
	uint32_t                                           Cinematic_3 : 1;                                          // 0x0000(0x0004) (Edit)
	uint32_t                                           Cinematic_4 : 1;                                          // 0x0000(0x0004) (Edit)
	uint32_t                                           Cinematic_5 : 1;                                          // 0x0000(0x0004) (Edit)
	uint32_t                                           Cinematic_6 : 1;                                          // 0x0000(0x0004) (Edit)
	uint32_t                                           Cinematic_7 : 1;                                          // 0x0000(0x0004) (Edit)
	uint32_t                                           Cinematic_8 : 1;                                          // 0x0000(0x0004) (Edit)
	uint32_t                                           Cinematic_9 : 1;                                          // 0x0000(0x0004) (Edit)
	uint32_t                                           Cinematic_10 : 1;                                         // 0x0000(0x0004) (Edit)
	uint32_t                                           Cinematic_11 : 1;                                         // 0x0000(0x0004) (Edit)
	uint32_t                                           Gameplay_2 : 1;                                           // 0x0000(0x0004) (Edit)
	uint32_t                                           Gameplay_3 : 1;                                           // 0x0000(0x0004) (Edit)
	uint32_t                                           Gameplay_4 : 1;                                           // 0x0000(0x0004) (Edit)
	uint32_t                                           Gameplay_5 : 1;                                           // 0x0000(0x0004) (Edit)
	uint32_t                                           Crowd : 1;                                                // 0x0000(0x0004) (Edit)
};
...
{
	uint32_t                                           Default : 1;                                              // 0x0000(0x0004) (Edit, Const)
	uint32_t                                           Nothing : 1;                                              // 0x0000(0x0004) (Const)
	uint32_t                                           Pawn : 1;                                                 // 0x0000(0x0004) (Edit, Const)
	uint32_t                                           Vehicle : 1;                                              // 0x0000(0x0004) (Edit, Const)
	uint32_t                                           Water : 1;                                                // 0x0000(0x0004) (Edit, Const)
	uint32_t                                           GameplayPhysics : 1;                                      // 0x0000(0x0004) (Edit, Const)
	uint32_t                                           EffectPhysics : 1;                                        // 0x0000(0x0004) (Edit, Const)
	uint32_t                                           Untitled1 : 1;                                            // 0x0000(0x0004) (Edit, Const)
	uint32_t                                           Untitled2 : 1;                                            // 0x0000(0x0004) (Edit, Const)
	uint32_t                                           Untitled3 : 1;                                            // 0x0000(0x0004) (Edit, Const)
	uint32_t                                           Untitled4 : 1;                                            // 0x0000(0x0004) (Edit, Const)
	uint32_t                                           Cloth : 1;                                                // 0x0000(0x0004) (Edit, Const)
	uint32_t                                           FluidDrain : 1;                                           // 0x0000(0x0004) (Edit, Const)
	uint32_t                                           SoftBody : 1;                                             // 0x0000(0x0004) (Edit, Const)
	uint32_t                                           FracturedMeshPart : 1;                                    // 0x0000(0x0004) (Edit, Const)
	uint32_t                                           BlockingVolume : 1;                                       // 0x0000(0x0004) (Edit, Const)
	uint32_t                                           DeadPawn : 1;                                             // 0x0000(0x0004) (Edit, Const)
	uint32_t                                           Clothing : 1;                                             // 0x0000(0x0004) (Edit, Const)
	uint32_t                                           ClothingCollision : 1;                                    // 0x0000(0x0004) (Edit, Const)
};
...
struct FViewTargetTransitionParams
{
	...
	uint32_t                                           bLockOutgoing : 1;                                        // 0x000C(0x0004) (Edit)
};
...
struct FConnectedPeerInfo
{
	...
	uint32_t                                           bLostConnectionToHost : 1;                                // 0x000C(0x0004)
};
...
struct FDebugTextInfo
{
	...
	uint32_t                                           bAbsoluteLocation : 1;                                    // 0x003C(0x0004)
	uint32_t                                           bKeepAttachedToActor : 1;                                 // 0x003C(0x0004)
...
{
	uint32_t                                           bSuccessful : 1;                                          // 0x0000(0x0004)
...
{
	uint32_t                                           bIsLocal : 1;                                             // 0x0000(0x0004)
...
struct FPresetGeneratedPoint
{
	...
	uint32_t                                           TangentsValid : 1;                                        // 0x0008(0x0004)
...
struct FFontImportOptionsData
{
	...
	uint32_t                                           bEnableAntialiasing : 1;                                  // 0x0014(0x0004) (Edit)
	uint32_t                                           bEnableBold : 1;                                          // 0x0014(0x0004) (Edit)
	uint32_t                                           bEnableItalic : 1;                                        // 0x0014(0x0004) (Edit)
	uint32_t                                           bEnableUnderline : 1;                                     // 0x0014(0x0004) (Edit)
	uint32_t                                           bAlphaOnly : 1;                                           // 0x0014(0x0004) (Edit)
	...
	uint32_t                                           bCreatePrintableOnly : 1;                                 // 0x005C(0x0004) (Edit)
	uint32_t                                           bIncludeASCIIRange : 1;                                   // 0x005C(0x0004) (Edit)
	struct FLinearColor                                ForegroundColor;                                          // 0x0060(0x0010) (Edit)
	uint32_t                                           bEnableDropShadow : 1;                                    // 0x0070(0x0004) (Edit)
	...
	uint32_t                                           bEnableLegacyMode : 1;                                    // 0x0094(0x0004) (Edit)
	int                                                Kerning;                                                  // 0x0098(0x0004) (Edit)
	uint32_t                                           bUseDistanceFieldAlpha : 1;                               // 0x009C(0x0004) (Edit)
...
struct FGameSessionInformation
{
	...
	uint32_t                                           bGameplaySessionInProgress : 1;                           // 0x0030(0x0004) (Const)
...
struct FPlayerInformation
{
	...
	uint32_t                                           bIsBot : 1;                                               // 0x0020(0x0004)
};
...
{
	uint32_t                                           bIsUnicode : 1;                                           // 0x0044(0x0004)
...
struct FSubTrackGroup
{
	...
	uint32_t                                           bIsCollapsed : 1;                                         // 0x0020(0x0004)
	uint32_t                                           bIsSelected : 1;                                          // 0x0020(0x0004) (Transient)
};
...
{
	uint32_t                                           bUseTwoSidedLighting : 1;                                 // 0x0000(0x0004) (Edit)
	uint32_t                                           bShadowIndirectOnly : 1;                                  // 0x0000(0x0004) (Edit)
	uint32_t                                           bUseEmissiveForStaticLighting : 1;                        // 0x0000(0x0004) (Edit)
...
{
	uint32_t                                           bInProgress : 1;                                          // 0x0000(0x0004)
...
struct FStringIdToStringMapping
{
	int                                                Id;                                                       // 0x0000(0x0004) (Const)
	struct FName                                       Name;                                                     // 0x0004(0x0008) (Const, Localized)
	uint32_t                                           bIsWildcard : 1;                                          // 0x000C(0x0004) (Const)
};
...
struct FPostProcessSettingsOverride
{
	...
	uint32_t                                           bBlendingIn : 1;                                          // 0x0174(0x0004)
	uint32_t                                           bBlendingOut : 1;                                         // 0x0174(0x0004)
...
struct FDebugDisplayProperty
{
	...
	uint32_t                                           bSpecialProperty : 1;                                     // 0x0010(0x0004)
};
...
struct FStaticMeshLODElement
{
	...
	uint32_t                                           bEnableShadowCasting : 1;                                 // 0x0008(0x0004) (Edit, Native)
	unsigned char                                      UnknownData00[0x4];                                       // 0x000C(0x0004) MISSED OFFSET
	uint32_t                                           bEnableCollision : 1;                                     // 0x0010(0x0004) (Edit, Native)
};
...
{
	uint32_t                                           bCastShadowAsMasked : 1;                                  // 0x0000(0x0004) (Edit)
	...
	uint32_t                                           bOverrideCastShadowAsMasked : 1;                          // 0x0018(0x0004)
	uint32_t                                           bOverrideEmissiveBoost : 1;                               // 0x0018(0x0004)
	uint32_t                                           bOverrideDiffuseBoost : 1;                                // 0x0018(0x0004)
	uint32_t                                           bOverrideSpecularBoost : 1;                               // 0x0018(0x0004)
	uint32_t                                           bOverrideExportResolutionScale : 1;                       // 0x0018(0x0004)
	uint32_t                                           bOverrideDistanceFieldPenumbraScale : 1;                  // 0x0018(0x0004)
};
...
{
	uint32_t                                           bLit : 1;                                                 // 0x0000(0x0004) (Edit)
};
...
{
	uint32_t                                           bEnabled : 1;                                             // 0x0010(0x0004) (AlwaysInit)
};
...
struct FUIAxisEmulationDefinition
{
	...
	uint32_t                                           bEmulateButtonPress : 1;                                  // 0x0010(0x0004)
...
{
	uint32_t                                           bEnabled : 1;                                             // 0x0000(0x0004)
};
...
struct FNavMeshPathParams
{
	...
	uint32_t                                           bCanMantle : 1;                                           // 0x0008(0x0004)
	uint32_t                                           bNeedsMantleValidityTest : 1;                             // 0x0008(0x0004)
	uint32_t                                           bAbleToSearch : 1;                                        // 0x0008(0x0004)
...
{
	uint32_t                                           bReplicated : 1;                                          // 0x0000(0x0004)
	uint32_t                                           bHidden : 1;                                              // 0x0000(0x0004)
	uint32_t                                           bSavedPosition : 1;                                       // 0x0000(0x0004)
...
struct FActorTickDropRate
{
	...
	uint32_t                                           bUseable : 1;                                             // 0x0010(0x0004) (Transient)
	uint32_t                                           bForceTickOnce : 1;                                       // 0x0010(0x0004) (Transient)
	uint32_t                                           bForceVisibleTick : 1;                                    // 0x0010(0x0004) (Transient)
};
...
struct FAnimBlendChild
{
	...
	uint32_t                                           bMirrorSkeleton : 1;                                      // 0x0018(0x0004)
	uint32_t                                           bIsAdditive : 1;                                          // 0x0018(0x0004)
...
struct FPerBoneMaskInfo
{
	...
	uint32_t                                           bWeightBasedOnNodeRules : 1;                              // 0x0028(0x0004) (Edit)
	uint32_t                                           bDisableForNonLocalHumanPlayers : 1;                      // 0x0028(0x0004) (Edit)
	uint32_t                                           bPendingBlend : 1;                                        // 0x0028(0x0004) (Transient)
...
struct FRandomAnimInfo
{
	...
	uint32_t                                           bStillFrame : 1;                                          // 0x0014(0x0004) (Edit)
...
struct FSynchGroup
{
	...
	uint32_t                                           bFireSlaveNotifies : 1;                                   // 0x0020(0x0004) (Edit)
...
struct FActiveDecalInfo
{
	...
	uint32_t                                           bRemoveNoReceivers : 1;                                   // 0x0010(0x0004)
};
...
{
	uint32_t                                           UseConstant : 1;                                          // 0x0034(0x0004)
...
{
	uint32_t                                           bIsShutdown : 1;                                          // 0x0000(0x0004)
...
struct FDeferredPartToSpawn
{
	...
	uint32_t                                           bExplosion : 1;                                           // 0x0020(0x0004)
};
...
struct FFragmentGroup
{
	...
	uint32_t                                           bGroupIsRooted : 1;                                       // 0x0010(0x0004)
};
...
{
	uint32_t                                           ACCUMULATE_DAMAGE : 1;                                    // 0x0000(0x0004) (Edit)
	uint32_t                                           ASSET_DEFINED_SUPPORT : 1;                                // 0x0000(0x0004) (Edit)
	uint32_t                                           WORLD_SUPPORT : 1;                                        // 0x0000(0x0004) (Edit)
	uint32_t                                           DEBRIS_TIMEOUT : 1;                                       // 0x0000(0x0004) (Edit)
	uint32_t                                           DEBRIS_MAX_SEPARATION : 1;                                // 0x0000(0x0004) (Edit)
	uint32_t                                           CRUMBLE_SMALLEST_CHUNKS : 1;                              // 0x0000(0x0004) (Edit)
	uint32_t                                           ACCURATE_RAYCASTS : 1;                                    // 0x0000(0x0004) (Edit)
	uint32_t                                           USE_VALID_BOUNDS : 1;                                     // 0x0000(0x0004) (Edit)
	uint32_t                                           FORM_EXTENDED_STRUCTURES : 1;                             // 0x0000(0x0004) (Edit)
};
...
{
	uint32_t                                           TAKE_IMPACT_DAMAGE : 1;                                   // 0x0000(0x0004) (Deprecated)
	uint32_t                                           IGNORE_POSE_UPDATES : 1;                                  // 0x0000(0x0004) (Deprecated)
	uint32_t                                           IGNORE_RAYCAST_CALLBACKS : 1;                             // 0x0000(0x0004) (Deprecated)
	uint32_t                                           IGNORE_CONTACT_CALLBACKS : 1;                             // 0x0000(0x0004) (Deprecated)
	uint32_t                                           USER_FLAG_1 : 1;                                          // 0x0000(0x0004) (Deprecated)
	uint32_t                                           USER_FLAG_2 : 1;                                          // 0x0000(0x0004) (Deprecated)
	uint32_t                                           USER_FLAG_3 : 1;                                          // 0x0000(0x0004) (Deprecated)
	uint32_t                                           USER_FLAG_4 : 1;                                          // 0x0000(0x0004) (Deprecated)
...
struct FNxDestructibleParameters
{
	...
	uint32_t                                           bFormExtendedStructures : 1;                              // 0x0078(0x0004) (Deprecated)
	...
	uint32_t                                           UseDynamicChunksGroupsMask : 1;                           // 0x00E4(0x0004) (Edit)
...
struct FPlayerLocationInfo
{
	...
	unsigned char                                      UnknownData00[0x3];                                       // 0x0001(0x0003) MISSED OFFSET
	uint32_t                                           bApplyStartAnimBlendWeight : 1;                           // 0x0004(0x0004) (Edit)
	uint32_t                                           bBackToStartLocation : 1;                                 // 0x0004(0x0004) (Edit)
	uint32_t                                           bFinishIdleAnimation : 1;                                 // 0x0004(0x0004) (Edit)
	uint32_t                                           bUsedDummyStartLocation : 1;                              // 0x0004(0x0004) (Edit)
};
...
struct FBoolTrackKey
{
	...
	uint32_t                                           Value : 1;                                                // 0x0004(0x0004) (Edit)
};
...
struct FAnimControlTrackKey
{
	...
	uint32_t                                           bLooping : 1;                                             // 0x0018(0x0004) (Edit)
	uint32_t                                           bReverse : 1;                                             // 0x0018(0x0004) (Edit)
	uint32_t                                           bEnableRootMotion : 1;                                    // 0x0018(0x0004) (Edit)
...
{
	uint32_t                                           bAllowAmbientOcclusion : 1;                               // 0x0000(0x0004) (Edit)
	uint32_t                                           bAllowDominantWholeSceneDynamicShadows : 1;               // 0x0000(0x0004) (Edit)
	uint32_t                                           bAllowMotionBlurSkinning : 1;                             // 0x0000(0x0004) (Edit)
	uint32_t                                           bAllowTemporalAA : 1;                                     // 0x0000(0x0004) (Edit)
	uint32_t                                           bAllowLightShafts : 1;                                    // 0x0000(0x0004) (Edit)
};
...
struct FParameterValueOverTime
{
	...
	uint32_t                                           bLoop : 1;                                                // 0x001C(0x0004) (Edit)
	uint32_t                                           bAutoActivate : 1;                                        // 0x001C(0x0004) (Edit)
	float                                              CycleTime;                                                // 0x0020(0x0004) (Edit)
	uint32_t                                           bNormalizeTime : 1;                                       // 0x0024(0x0004) (Edit)
	float                                              OffsetTime;                                               // 0x0028(0x0004) (Edit)
	uint32_t                                           bOffsetFromEnd : 1;                                       // 0x002C(0x0004) (Edit)
};
...
struct FParticleSysParam
{
	...
	uint32_t                                           bUseBone : 1;                                             // 0x0050(0x0004) (Edit)
};
...
{
	uint32_t                                           bOpaque : 1;                                              // 0x0000(0x0004)
	uint32_t                                           bTranslucent : 1;                                         // 0x0000(0x0004)
	uint32_t                                           bDistortion : 1;                                          // 0x0000(0x0004)
	uint32_t                                           bOneLayerDistortionRelevance : 1;                         // 0x0000(0x0004)
	uint32_t                                           bLit : 1;                                                 // 0x0000(0x0004)
	uint32_t                                           bUsesSceneColor : 1;                                      // 0x0000(0x0004)
};
...
{
	uint32_t                                           UsePSysCompLocation : 1;                                  // 0x0034(0x0004)
	struct FVector                                     Normal;                                                   // 0x0038(0x000C)
};
...
{
	uint32_t                                           bModify : 1;                                              // 0x0000(0x0004) (Edit)
	uint32_t                                           bScale : 1;                                               // 0x0000(0x0004) (Edit)
	uint32_t                                           bLock : 1;                                                // 0x0000(0x0004) (Edit)
};
...
{
	struct FName                                       ParameterName;                                            // 0x0000(0x0008) (Edit)
	uint32_t                                           bGetSeedFromInstance : 1;                                 // 0x0008(0x0004) (Edit)
	uint32_t                                           bInstanceSeedIsIndex : 1;                                 // 0x0008(0x0004) (Edit)
	uint32_t                                           bResetSeedOnEmitterLooping : 1;                           // 0x0008(0x0004) (Edit)
	uint32_t                                           bRandomlySelectSeedArray : 1;                             // 0x0008(0x0004) (Edit)
...
struct FParticleEvent_GenerateInfo
{
	...
	uint32_t                                           FirstTimeOnly : 1;                                        // 0x0010(0x0004) (Edit)
	uint32_t                                           LastTimeOnly : 1;                                         // 0x0010(0x0004) (Edit)
	uint32_t                                           UseReflectedImpactVector : 1;                             // 0x0010(0x0004) (Edit)
...
{
	uint32_t                                           bProcessDuringSpawn : 1;                                  // 0x0000(0x0004) (Edit)
	uint32_t                                           bProcessDuringUpdate : 1;                                 // 0x0000(0x0004) (Edit)
	uint32_t                                           bUseEmitterTime : 1;                                      // 0x0000(0x0004) (Edit)
};
...
struct FEmitterDynamicParameter
{
	...
	uint32_t                                           bUseEmitterTime : 1;                                      // 0x0008(0x0004) (Edit)
	uint32_t                                           bSpawnTimeOnly : 1;                                       // 0x0008(0x0004) (Edit)
	TEnumAsByte<EEmitterDynamicParameterValue>         ValueMethod;                                              // 0x000C(0x0001) (Edit)
	unsigned char                                      UnknownData00[0x3];                                       // 0x000D(0x0003) MISSED OFFSET
	uint32_t                                           bScaleVelocityByParamValue : 1;                           // 0x0010(0x0004) (Edit)
...
struct FVehicleState
{
	...
	uint32_t                                           bServerHandbrake : 1;                                     // 0x0044(0x0004)
...
struct FSeqOpInputLink
{
	...
	uint32_t                                           bHasImpulse : 1;                                          // 0x0010(0x0004)
	int                                                QueuedActivations;                                        // 0x0014(0x0004)
	uint32_t                                           bDisabled : 1;                                            // 0x0018(0x0004)
	uint32_t                                           bDisabledPIE : 1;                                         // 0x0018(0x0004)
	class USequenceOp*                                 LinkedOp;                                                 // 0x001C(0x0008)
	int                                                DrawY;                                                    // 0x0024(0x0004)
	uint32_t                                           bHidden : 1;                                              // 0x0028(0x0004)
	float                                              ActivateDelay;                                            // 0x002C(0x0004)
	uint32_t                                           bMoving : 1;                                              // 0x0030(0x0004) (Transient)
	uint32_t                                           bClampedMax : 1;                                          // 0x0030(0x0004)
	uint32_t                                           bClampedMin : 1;                                          // 0x0030(0x0004)
...
struct FSeqOpOutputLink
{
	...
	uint32_t                                           bHasImpulse : 1;                                          // 0x0020(0x0004)
	uint32_t                                           bDisabled : 1;                                            // 0x0020(0x0004)
	uint32_t                                           bDisabledPIE : 1;                                         // 0x0020(0x0004)
	class USequenceOp*                                 LinkedOp;                                                 // 0x0024(0x0008)
	float                                              ActivateDelay;                                            // 0x002C(0x0004)
	int                                                DrawY;                                                    // 0x0030(0x0004)
	uint32_t                                           bHidden : 1;                                              // 0x0034(0x0004)
	uint32_t                                           bMoving : 1;                                              // 0x0034(0x0004) (Transient)
	uint32_t                                           bClampedMax : 1;                                          // 0x0034(0x0004)
	uint32_t                                           bClampedMin : 1;                                          // 0x0034(0x0004)
	int                                                OverrideDelta;                                            // 0x0038(0x0004)
	float                                              PIEActivationTime;                                        // 0x003C(0x0004) (Transient)
	uint32_t                                           bIsActivated : 1;                                         // 0x0040(0x0004) (Transient, NoImport)
};
...
struct FSeqVarLink
{
	...
	uint32_t                                           bWriteable : 1;                                           // 0x0038(0x0004)
	uint32_t                                           bSequenceNeverReadsOnlyWritesToThisVar : 1;               // 0x0038(0x0004)
	uint32_t                                           bModifiesLinkedObject : 1;                                // 0x0038(0x0004)
	uint32_t                                           bHidden : 1;                                              // 0x0038(0x0004)
	...
	uint32_t                                           bAllowAnyType : 1;                                        // 0x0050(0x0004)
	uint32_t                                           bMoving : 1;                                              // 0x0050(0x0004) (Transient)
	uint32_t                                           bClampedMax : 1;                                          // 0x0050(0x0004)
	uint32_t                                           bClampedMin : 1;                                          // 0x0050(0x0004)
...
struct FSeqEventLink
{
	...
	uint32_t                                           bHidden : 1;                                              // 0x002C(0x0004)
	uint32_t                                           bMoving : 1;                                              // 0x002C(0x0004) (Transient)
	uint32_t                                           bClampedMax : 1;                                          // 0x002C(0x0004)
	uint32_t                                           bClampedMin : 1;                                          // 0x002C(0x0004)
...
struct FQueuedActivationInfo
{
	...
	uint32_t                                           bPushTop : 1;                                             // 0x0028(0x0004)
};
...
{
	uint32_t                                           TEXTUREGROUP_World : 1;                                   // 0x0000(0x0004) (Edit, Const)
	uint32_t                                           TEXTUREGROUP_WorldNormalMap : 1;                          // 0x0000(0x0004) (Edit, Const)
	uint32_t                                           TEXTUREGROUP_WorldSpecular : 1;                           // 0x0000(0x0004) (Edit, Const)
	uint32_t                                           TEXTUREGROUP_Character : 1;                               // 0x0000(0x0004) (Edit, Const)
	uint32_t                                           TEXTUREGROUP_CharacterNormalMap : 1;                      // 0x0000(0x0004) (Edit, Const)
	uint32_t                                           TEXTUREGROUP_CharacterSpecular : 1;                       // 0x0000(0x0004) (Edit, Const)
	uint32_t                                           TEXTUREGROUP_Weapon : 1;                                  // 0x0000(0x0004) (Edit, Const)
	uint32_t                                           TEXTUREGROUP_WeaponNormalMap : 1;                         // 0x0000(0x0004) (Edit, Const)
	uint32_t                                           TEXTUREGROUP_WeaponSpecular : 1;                          // 0x0000(0x0004) (Edit, Const)
	uint32_t                                           TEXTUREGROUP_Vehicle : 1;                                 // 0x0000(0x0004) (Edit, Const)
	uint32_t                                           TEXTUREGROUP_VehicleNormalMap : 1;                        // 0x0000(0x0004) (Edit, Const)
	uint32_t                                           TEXTUREGROUP_VehicleSpecular : 1;                         // 0x0000(0x0004) (Edit, Const)
	uint32_t                                           TEXTUREGROUP_Cinematic : 1;                               // 0x0000(0x0004) (Edit, Const)
	uint32_t                                           TEXTUREGROUP_Effects : 1;                                 // 0x0000(0x0004) (Edit, Const)
	uint32_t                                           TEXTUREGROUP_EffectsNotFiltered : 1;                      // 0x0000(0x0004) (Edit, Const)
	uint32_t                                           TEXTUREGROUP_Skybox : 1;                                  // 0x0000(0x0004) (Edit, Const)
	uint32_t                                           TEXTUREGROUP_UI : 1;                                      // 0x0000(0x0004) (Edit, Const)
	uint32_t                                           TEXTUREGROUP_Lightmap : 1;                                // 0x0000(0x0004) (Edit, Const)
	uint32_t                                           TEXTUREGROUP_RenderTarget : 1;                            // 0x0000(0x0004) (Edit, Const)
	uint32_t                                           TEXTUREGROUP_MobileFlattened : 1;                         // 0x0000(0x0004) (Edit, Const)
	uint32_t                                           TEXTUREGROUP_ProcBuilding_Face : 1;                       // 0x0000(0x0004) (Edit, Const)
	uint32_t                                           TEXTUREGROUP_ProcBuilding_LightMap : 1;                   // 0x0000(0x0004) (Edit, Const)
	uint32_t                                           TEXTUREGROUP_Shadowmap : 1;                               // 0x0000(0x0004) (Edit, Const)
	uint32_t                                           TEXTUREGROUP_ColorLookupTable : 1;                        // 0x0000(0x0004) (Edit, Const)
	uint32_t                                           TEXTUREGROUP_Terrain_Heightmap : 1;                       // 0x0000(0x0004) (Edit, Const)
	uint32_t                                           TEXTUREGROUP_Terrain_Weightmap : 1;                       // 0x0000(0x0004) (Edit, Const)
	uint32_t                                           TEXTUREGROUP_ImageBasedReflection : 1;                    // 0x0000(0x0004) (Edit, Const)
	uint32_t                                           TEXTUREGROUP_Bokeh : 1;                                   // 0x0000(0x0004) (Edit, Const)
	uint32_t                                           TEXTUREGROUP_WorldExtend : 1;                             // 0x0000(0x0004) (Edit, Const)
	uint32_t                                           TEXTUREGROUP_WorldExtendNormalMap : 1;                    // 0x0000(0x0004) (Edit, Const)
	uint32_t                                           TEXTUREGROUP_WorldExtendSpecular : 1;                     // 0x0000(0x0004) (Edit, Const)
	uint32_t                                           TEXTUREGROUP_EffectsNormalMap : 1;                        // 0x0000(0x0004) (Edit, Const)
};
...
struct FSwitchObjectCase
{
	...
	uint32_t                                           bFallThru : 1;                                            // 0x0008(0x0004) (Edit)
	uint32_t                                           bDefaultValue : 1;                                        // 0x0008(0x0004) (Edit)
};
...
struct FAnimSetBakeAndPruneStatus
{
	...
	uint32_t                                           bReferencedButUnused : 1;                                 // 0x0010(0x0004) (Edit, EditConst)
	uint32_t                                           bSkipBakeAndPrune : 1;                                    // 0x0010(0x0004) (Edit)
	uint32_t                                           bSkipCooking : 1;                                         // 0x0010(0x0004) (Edit)
};
...
{
	uint32_t                                           bCurrentlyPlaying : 1;                                    // 0x0000(0x0004)
};
...
struct FLocalizedSubtitle
{
	...
	uint32_t                                           bMature : 1;                                              // 0x0020(0x0004)
	uint32_t                                           bManualWordWrap : 1;                                      // 0x0020(0x0004)
	uint32_t                                           bSingleLine : 1;                                          // 0x0020(0x0004)
};
...
struct FLandscapeLayerStruct
{
	...
	uint32_t                                           bSelected : 1;                                            // 0x001C(0x0004) (Transient)
...
struct FTerrainLayer
{
	...
	uint32_t                                           Highlighted : 1;                                          // 0x001C(0x0004) (Edit)
	uint32_t                                           WireframeHighlighted : 1;                                 // 0x001C(0x0004) (Edit)
	uint32_t                                           Hidden : 1;                                               // 0x001C(0x0004) (Edit)
...
struct FFilterLimit
{
	uint32_t                                           Enabled : 1;                                              // 0x0000(0x0004) (Edit)
...
{
	uint32_t                                           UseNoise : 1;                                             // 0x0000(0x0004) (Edit)
...
struct FKeyBind
{
	...
	uint32_t                                           Control : 1;                                              // 0x0018(0x0004) (Config)
	uint32_t                                           Shift : 1;                                                // 0x0018(0x0004) (Config)
	uint32_t                                           Alt : 1;                                                  // 0x0018(0x0004) (Config)
	uint32_t                                           bIgnoreCtrl : 1;                                          // 0x0018(0x0004) (Config)
	uint32_t                                           bIgnoreShift : 1;                                         // 0x0018(0x0004) (Config)
	uint32_t                                           bIgnoreAlt : 1;                                           // 0x0018(0x0004) (Config)
};
...
struct FTouchTracker
{
	...
	unsigned char                                      UnknownData00[0x3];                                       // 0x0011(0x0003) MISSED OFFSET
	uint32_t                                           bTrapInput : 1;                                           // 0x0014(0x0004)
};
...
struct FOnlineFriendMessage
{
	...
	uint32_t                                           bIsFriendInvite : 1;                                      // 0x0018(0x0004)
	uint32_t                                           bIsGameInvite : 1;                                        // 0x0018(0x0004)
	uint32_t                                           bWasAccepted : 1;                                         // 0x0018(0x0004)
	uint32_t                                           bWasDenied : 1;                                           // 0x0018(0x0004)
...
struct FOnlineFriend
{
	...
	uint32_t                                           bIsOnline : 1;                                            // 0x0034(0x0004) (Const)
	uint32_t                                           bIsPlaying : 1;                                           // 0x0034(0x0004) (Const)
	uint32_t                                           bIsPlayingThisGame : 1;                                   // 0x0034(0x0004) (Const)
	uint32_t                                           bIsJoinable : 1;                                          // 0x0034(0x0004) (Const)
	uint32_t                                           bHasVoiceSupport : 1;                                     // 0x0034(0x0004) (Const)
	uint32_t                                           bHaveInvited : 1;                                         // 0x0034(0x0004)
	uint32_t                                           bHasInvitedYou : 1;                                       // 0x0034(0x0004) (Const)
};
...
struct FOnlinePartyMember
{
	...
	uint32_t                                           bIsLocal : 1;                                             // 0x0020(0x0004) (Const)
	uint32_t                                           bIsInPartyVoice : 1;                                      // 0x0020(0x0004) (Const)
	uint32_t                                           bIsTalking : 1;                                           // 0x0020(0x0004) (Const)
	uint32_t                                           bIsInGameSession : 1;                                     // 0x0020(0x0004) (Const)
	uint32_t                                           bIsPlayingThisGame : 1;                                   // 0x0020(0x0004) (Const)
...
struct FAchievementDetails
{
	...
	uint32_t                                           bIsSecret : 1;                                            // 0x0044(0x0004) (Const)
	uint32_t                                           bWasAchievedOnline : 1;                                   // 0x0044(0x0004) (Const)
	uint32_t                                           bWasAchievedOffline : 1;                                  // 0x0044(0x0004) (Const)
};
...
struct FGameResourceDataProvider
{
	struct FName                                       ProviderTag;                                              // 0x0000(0x0008) (Config)
	struct FString                                     ProviderClassName;                                        // 0x0008(0x0010) (Config, NeedCtorLink)
	uint32_t                                           bExpandProviders : 1;                                     // 0x0018(0x0004) (Config)
...
struct FUIRangeData
{
	...
	uint32_t                                           bIntRange : 1;                                            // 0x0010(0x0004) (Edit)
};
...
struct FLensFlareElement
{
	...
	uint32_t                                           bIsEnabled : 1;                                           // 0x000C(0x0004) (Edit)
	uint32_t                                           bUseSourceDistance : 1;                                   // 0x000C(0x0004) (Edit)
	uint32_t                                           bNormalizeRadialDistance : 1;                             // 0x000C(0x0004) (Edit)
	uint32_t                                           bModulateColorBySource : 1;                               // 0x000C(0x0004) (Edit)
	...
	uint32_t                                           bOrientTowardsSource : 1;                                 // 0x00BC(0x0004) (Edit)
...
struct FSoundClassProperties
{
	...
	uint32_t                                           bApplyEffects : 1;                                        // 0x001C(0x0004) (Edit)
	uint32_t                                           bAlwaysPlay : 1;                                          // 0x001C(0x0004) (Edit)
	uint32_t                                           bIsUISound : 1;                                           // 0x001C(0x0004) (Edit)
	uint32_t                                           bIsMusic : 1;                                             // 0x001C(0x0004) (Edit)
	uint32_t                                           bReverb : 1;                                              // 0x001C(0x0004) (Edit)
	uint32_t                                           bCenterChannelOnly : 1;                                   // 0x001C(0x0004) (Edit)
	uint32_t                                           bApplyAmbientVolumes : 1;                                 // 0x001C(0x0004) (Edit)
};
...
struct FSoundClassAdjuster
{
	...
	uint32_t                                           bApplyToChildren : 1;                                     // 0x0014(0x0004) (Edit)
...
{
	uint32_t                                           IsUpdated : 1;                                            // 0x0000(0x0004)
	int                                                Index;                                                    // 0x0004(0x0004)
	...
	uint32_t                                           IsStop : 1;                                               // 0x0024(0x0004)
...
struct FAttachment
{
	...
	uint32_t                                           bIgnoreAttachLocation : 1;                                // 0x0034(0x0004) (Edit)
	uint32_t                                           bIgnoreAttachRotation : 1;                                // 0x0034(0x0004) (Edit)
	uint32_t                                           bIgnoreAttachWorldRotation : 1;                           // 0x0034(0x0004) (Edit)
...
{
	TArray<uint32_t>                                   HiddenMaterials;                                          // 0x0000(0x0010) (Const, NeedCtorLink)
	uint32_t                                           bNeedsInstanceWeightUpdate : 1;                           // 0x0010(0x0004) (Const)
	uint32_t                                           bAlwaysUseInstanceWeights : 1;                            // 0x0010(0x0004) (Const)
...
struct FSkeletalMeshLODInfo
{
	...
	TArray<uint32_t>                                   bEnableShadowCasting;                                     // 0x0018(0x0010) (Edit, EditFixedSize, NeedCtorLink)
	...
	uint32_t                                           bDisableCompressions : 1;                                 // 0x0048(0x0004) (Edit)
	uint32_t                                           bHasBeenSimplified : 1;                                   // 0x0048(0x0004)
};
...
struct FSkeletalMeshOptimizationSettings
{
	...
	uint32_t                                           bRecalcNormals : 1;                                       // 0x0020(0x0004)
	float                                              NormalsThreshold;                                         // 0x0024(0x0004)
	uint32_t                                           bUseVertexLock : 1;                                       // 0x0028(0x0004)
	uint32_t                                           bUseVertexWeight : 1;                                     // 0x0028(0x0004)
	uint32_t                                           bEnableSkeletonSimplification : 1;                        // 0x0028(0x0004)
	uint32_t                                           bLockSocketBones : 1;                                     // 0x0028(0x0004)
...
struct FPBScopeProcessInfo
{
	...
	uint32_t                                           bGenerateLODPoly : 1;                                     // 0x0018(0x0004)
	uint32_t                                           bPartOfNonRect : 1;                                       // 0x0018(0x0004)
};
...
struct FBuildingMeshInfo
{
	...
	uint32_t                                           bMeshScaleTranslation : 1;                                // 0x0024(0x0004) (Edit)
	uint32_t                                           bOverrideMeshLightMapRes : 1;                             // 0x0024(0x0004) (Edit)
...
struct FRBSplitInfo
{
	uint32_t                                           bFixSize : 1;                                             // 0x0000(0x0004) (Edit)
...
struct FPBVariationInfo
{
	...
	uint32_t                                           bMeshOnTopOfFacePoly : 1;                                 // 0x0008(0x0004) (Edit)
};
...
struct FCameraShakeInstance
{
	...
	uint32_t                                           bBlendingIn : 1;                                          // 0x0014(0x0004)
	float                                              CurrentBlendInTime;                                       // 0x0018(0x0004)
	uint32_t                                           bBlendingOut : 1;                                         // 0x001C(0x0004)
...
{
	uint32_t                                           bWasLaunchedViaNotification : 1;                          // 0x0000(0x0004)
...
struct FFriendsQuery
{
	...
	uint32_t                                           bIsFriend : 1;                                            // 0x0008(0x0004)
};
...
{
	uint32_t                                           bIsUserGeneratedImage : 1;                                // 0x0000(0x0004)
	uint32_t                                           bIsGameGeneratedImage : 1;                                // 0x0000(0x0004)
	uint32_t                                           bIsAchievementImage : 1;                                  // 0x0000(0x0004)
	uint32_t                                           bIsMediaImage : 1;                                        // 0x0000(0x0004)
};
...
{
	uint32_t                                           bCanPostImage : 1;                                        // 0x0000(0x0004) (Const)
	uint32_t                                           bCanPostLink : 1;                                         // 0x0000(0x0004) (Const)
};
...
struct FRemoteTalker
{
	...
	uint32_t                                           bWasTalking : 1;                                          // 0x000C(0x0004)
	uint32_t                                           bIsTalking : 1;                                           // 0x000C(0x0004)
	uint32_t                                           bIsRegistered : 1;                                        // 0x000C(0x0004)
};
...
struct FLocalTalker
{
	uint32_t                                           bHasVoice : 1;                                            // 0x0000(0x0004)
	uint32_t                                           bHasNetworkedVoice : 1;                                   // 0x0000(0x0004)
	uint32_t                                           bIsRecognizingSpeech : 1;                                 // 0x0000(0x0004)
	uint32_t                                           bWasTalking : 1;                                          // 0x0000(0x0004)
	uint32_t                                           bIsTalking : 1;                                           // 0x0000(0x0004)
	uint32_t                                           bIsRegistered : 1;                                        // 0x0000(0x0004)
};
...
{
	uint32_t                                           bDebugMode : 1;                                           // 0x0000(0x0004) (Edit)
	uint32_t                                           bStatsEnabled : 1;                                        // 0x0000(0x0004) (Edit)
	uint32_t                                           bGatherBSPSurfacesAcrossComponents : 1;                   // 0x0000(0x0004) (Edit)
	float                                              CoplanarTolerance;                                        // 0x0004(0x0004) (Edit)
	uint32_t                                           bUseDeterministicLighting : 1;                            // 0x0008(0x0004) (Edit)
	uint32_t                                           bUseImmediateImport : 1;                                  // 0x0008(0x0004) (Edit)
	uint32_t                                           bImmediateProcessMappings : 1;                            // 0x0008(0x0004) (Edit)
	uint32_t                                           bSortMappings : 1;                                        // 0x0008(0x0004) (Edit)
	uint32_t                                           bDumpBinaryFiles : 1;                                     // 0x0008(0x0004) (Edit)
	uint32_t                                           bDebugMaterials : 1;                                      // 0x0008(0x0004) (Edit)
	uint32_t                                           bPadMappings : 1;                                         // 0x0008(0x0004) (Edit)
	uint32_t                                           bDebugPaddings : 1;                                       // 0x0008(0x0004) (Edit)
	uint32_t                                           bOnlyCalcDebugTexelMappings : 1;                          // 0x0008(0x0004) (Edit)
	uint32_t                                           bUseRandomColors : 1;                                     // 0x0008(0x0004) (Edit)
	uint32_t                                           bColorBordersGreen : 1;                                   // 0x0008(0x0004) (Edit)
	uint32_t                                           bColorByExecutionTime : 1;                                // 0x0008(0x0004) (Edit)
	float                                              ExecutionTimeDivisor;                                     // 0x000C(0x0004) (Edit)
	uint32_t                                           bInitialized : 1;                                         // 0x0010(0x0004)
};
...
{
	uint32_t                                           bDistributionEnabled : 1;                                 // 0x0000(0x0004) (Edit)
	uint32_t                                           bForceContentExport : 1;                                  // 0x0000(0x0004) (Edit)
	uint32_t                                           bInitialized : 1;                                         // 0x0000(0x0004)
};
...
struct FMobileDistanceFieldParams
{
	...
	uint32_t                                           EnableShadow : 1;                                         // 0x000C(0x0004)
...
struct FInputEventParameters
{
	...
	uint32_t                                           bAltPressed : 1;                                          // 0x001C(0x0004) (Const, Transient, AlwaysInit)
	uint32_t                                           bCtrlPressed : 1;                                         // 0x001C(0x0004) (Const, Transient, AlwaysInit)
	uint32_t                                           bShiftPressed : 1;                                        // 0x001C(0x0004) (Const, Transient, AlwaysInit)
};
...
struct FActorToLookAt
{
	...
	uint32_t                                           CurrentlyBeingLookedAt : 1;                               // 0x0018(0x0004)
};
...
{
	uint32_t                                           bShouldBeLoaded : 1;                                      // 0x0000(0x0004) (Edit)
	uint32_t                                           bShouldBeVisible : 1;                                     // 0x0000(0x0004) (Edit)
	uint32_t                                           bShouldBlockOnLoad : 1;                                   // 0x0000(0x0004) (Edit)
