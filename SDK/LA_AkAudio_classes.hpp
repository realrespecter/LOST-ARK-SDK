...
{
public:
	uint32_t                                           bAutoPlay : 1;                                            // 0x0274(0x0004)
	uint32_t                                           bIsActive : 1;                                            // 0x0274(0x0004) (Transient)
	uint32_t                                           bRealPlay : 1;                                            // 0x0274(0x0004) (Transient)
	uint32_t                                           bDeactiveWhenRealPlayIsStop : 1;                          // 0x0274(0x0004) (Edit)
	uint32_t                                           bShowAkAmbientSoundRadius : 1;                            // 0x0274(0x0004) (Edit, Transient)
	uint32_t                                           StopWhenOwnerIsDestroyed : 1;                             // 0x0274(0x0004) (Edit)
	uint32_t                                           bIsPlaying : 1;                                           // 0x0274(0x0004) (Transient)
...
public:
	...
	uint32_t                                           bStopWhenOwnerDestroyed : 1;                              // 0x00B8(0x0004)
...
{
public:
	uint32_t                                           Async : 1;                                                // 0x0170(0x0004) (Edit)
	uint32_t                                           bWaitingCallback : 1;                                     // 0x0170(0x0004) (Transient)
...
public:
	...
	uint32_t                                           Running : 1;                                              // 0x0184(0x0004) (Transient)
