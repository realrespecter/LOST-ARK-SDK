...
public:
	...
	char                                               pad_0084[68];                                             // 0x0000(0x0000) NOT AUTO-GENERATED PROPERTY
...
public:
	...
	uint8_t                                            OperPrecendence;                                          // 0x0000(0x0000) NOT AUTO-GENERATED PROPERTY
...
public:
	...
	uint32_t                                           bCreateNew : 1;                                           // 0x0088(0x0004)
	uint32_t                                           bEditAfterNew : 1;                                        // 0x0088(0x0004)
	uint32_t                                           bEditorImport : 1;                                        // 0x0088(0x0004)
	uint32_t                                           bText : 1;                                                // 0x0088(0x0004)
...
public:
	...
	uint32_t                                           bCanBeBaked : 1;                                          // 0x0070(0x0004) (Edit)
	uint32_t                                           bIsDirty : 1;                                             // 0x0070(0x0004)
...
public:
	...
	uint32_t                                           IsServer : 1;                                             // 0x00A8(0x0004)
	uint32_t                                           IsClient : 1;                                             // 0x00A8(0x0004)
	uint32_t                                           IsEditor : 1;                                             // 0x00A8(0x0004)
	uint32_t                                           LogToConsole : 1;                                         // 0x00A8(0x0004)
	uint32_t                                           ShowErrorCount : 1;                                       // 0x00A8(0x0004)
...
// Class Core.Class
// 0x0160 (0x027C - 0x011C)
class UClass : public UState
{
public:
	char                                               pad_011C[176];                                            // 0x0000(0x0000) NOT AUTO-GENERATED PROPERTY
	class UObject*                                     ClassDefaultObject;                                       // 0x0000(0x0000) NOT AUTO-GENERATED PROPERTY
	char                                               pad_01D4[168];                                            // 0x0000(0x0000) NOT AUTO-GENERATED PROPERTY
	...
	inline UObject* CreateDefaultObject()
	{
		...
		auto EFEngine = reinterpret_cast<uint64_t>(GetModuleHandleA("EFEngine.dll"));
		static Fn fn = (Fn)(EFEngine + 0x249E70);
