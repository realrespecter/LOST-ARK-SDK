...
struct FRequiredMobileInputConfig
{
	...
	uint32_t                                           bIsAttractModeGroup : 1;                                  // 0x0020(0x0004) (Config)
};
...
struct FBehaviorEntry
{
	...
	uint32_t                                           bNeverRepeat : 1;                                         // 0x0014(0x0004) (Edit)
	uint32_t                                           bHasBeenUsed : 1;                                         // 0x0014(0x0004)
	uint32_t                                           bCanBeUsed : 1;                                           // 0x0014(0x0004)
};
...
struct FAvoidOtherSampleItem
{
	...
	uint32_t                                           bFallbackOnly : 1;                                        // 0x0008(0x0004) (Edit)
};
...
struct FCrowdSpawnInfoItem
{
	...
	uint32_t                                           bSpawningActive : 1;                                      // 0x0008(0x0004)
	...
	uint32_t                                           bForceObstacleChecking : 1;                               // 0x0050(0x0004)
	uint32_t                                           bForceNavMeshPathing : 1;                                 // 0x0050(0x0004)
	uint32_t                                           bEnableCrowdLightEnvironment : 1;                         // 0x0050(0x0004)
	uint32_t                                           bCastShadows : 1;                                         // 0x0050(0x0004)
...
struct FUVCoords
{
	uint32_t                                           bCustomCoords : 1;                                        // 0x0000(0x0004) (Edit)
...
struct FTouchData
{
	...
	uint32_t                                           bInUse : 1;                                               // 0x002C(0x0004)
...
struct FPropertyInfo
{
	...
	uint32_t                                           bModifyProperty : 1;                                      // 0x0008(0x0004) (Edit)
...
struct FCamFocusPointParams
{
	...
	uint32_t                                           bAlwaysFocus : 1;                                         // 0x0030(0x0004) (Edit)
	uint32_t                                           bAdjustCamera : 1;                                        // 0x0030(0x0004) (Edit)
	uint32_t                                           bIgnoreTrace : 1;                                         // 0x0030(0x0004) (Edit)
...
struct FScreenShakeStruct
{
	...
	uint32_t                                           bOverrideTargetingDampening : 1;                          // 0x0070(0x0004)
...
struct FScreenShakeAnimStruct
{
	...
	uint32_t                                           bUseDirectionalAnimVariants : 1;                          // 0x0008(0x0004)
	...
	uint32_t                                           bRandomSegment : 1;                                       // 0x0034(0x0004)
	float                                              RandomSegmentDuration;                                    // 0x0038(0x0004)
	uint32_t                                           bSingleInstance : 1;                                      // 0x003C(0x0004)
};
...
{
	uint32_t                                           bIsDragging : 1;                                          // 0x0000(0x0004)
	int                                                IndexFrom;                                                // 0x0004(0x0004)
	uint32_t                                           bIsOver : 1;                                              // 0x0008(0x0004)
	int                                                IndexOver;                                                // 0x000C(0x0004)
	uint32_t                                           bCanDropInOver : 1;                                       // 0x0010(0x0004)
...
{
	uint32_t                                           bIsDragItem : 1;                                          // 0x0000(0x0004)
...
struct FSelectedMenuItem
{
	...
	uint32_t                                           bEndOfList : 1;                                           // 0x0008(0x0004)
};
...
struct FMenuListDragInfo
{
	...
	uint32_t                                           bHasSelectedChanged : 1;                                  // 0x0050(0x0004)
};
...
{
	uint32_t                                           bIsMoving : 1;                                            // 0x0000(0x0004)
