...
public:
	...
	uint32_t                                           bHasRunawayCommandList : 1;                               // 0x0484(0x0004) (Transient)
	uint32_t                                           bAILogging : 1;                                           // 0x0484(0x0004) (Edit, Config)
	uint32_t                                           bAILogToWindow : 1;                                       // 0x0484(0x0004) (Edit, Config)
	uint32_t                                           bFlushAILogEachLine : 1;                                  // 0x0484(0x0004) (Edit, Config)
	uint32_t                                           bMapBasedLogName : 1;                                     // 0x0484(0x0004) (Edit, Config)
	uint32_t                                           bAIDrawDebug : 1;                                         // 0x0484(0x0004) (Edit, Config)
	uint32_t                                           bAIBroken : 1;                                            // 0x0484(0x0004) (Transient)
...
public:
	...
	uint32_t                                           bAllowNewSameClassInstance : 1;                           // 0x0078(0x0004)
	uint32_t                                           bReplaceActiveSameClassInstance : 1;                      // 0x0078(0x0004)
	uint32_t                                           bAborted : 1;                                             // 0x0078(0x0004) (Transient)
	uint32_t                                           bIgnoreNotifies : 1;                                      // 0x0078(0x0004)
	uint32_t                                           bIgnoreStepAside : 1;                                     // 0x0078(0x0004)
	uint32_t                                           bPendingPop : 1;                                          // 0x0078(0x0004) (Transient)
...
{
public:
	uint32_t                                           bWarnCrowdMembers : 1;                                    // 0x0778(0x0004)
	uint32_t                                           bDebugCrowdAwareness : 1;                                 // 0x0778(0x0004) (Edit)
	uint32_t                                           bIsWarmupPaused : 1;                                      // 0x0778(0x0004) (Transient)
...
public:
	...
	uint32_t                                           bUniformScale : 1;                                        // 0x02DC(0x0004)
	uint32_t                                           bCheckForObstacles : 1;                                   // 0x02DC(0x0004) (Edit)
	uint32_t                                           bUseNavMeshPathing : 1;                                   // 0x02DC(0x0004) (Edit)
	uint32_t                                           bWantsSeePlayerNotification : 1;                          // 0x02DC(0x0004)
	uint32_t                                           bAllowPitching : 1;                                       // 0x02DC(0x0004) (Edit)
	uint32_t                                           bHitObstacle : 1;                                         // 0x02DC(0x0004)
	uint32_t                                           bBadHitNormal : 1;                                        // 0x02DC(0x0004)
	uint32_t                                           bSimulateThisTick : 1;                                    // 0x02DC(0x0004)
	uint32_t                                           bPotentialEncounter : 1;                                  // 0x02DC(0x0004)
	uint32_t                                           bIsPanicked : 1;                                          // 0x02DC(0x0004)
	uint32_t                                           bWantsGroupIdle : 1;                                      // 0x02DC(0x0004)
	uint32_t                                           bPreferVisibleDestination : 1;                            // 0x02DC(0x0004) (Edit)
	uint32_t                                           bPreferVisibleDestinationOnSpawn : 1;                     // 0x02DC(0x0004) (Edit)
	uint32_t                                           bHasNotifiedSpawner : 1;                                  // 0x02DC(0x0004)
	uint32_t                                           bIsInSpawnPool : 1;                                       // 0x02DC(0x0004)
	uint32_t                                           bPaused : 1;                                              // 0x02DC(0x0004) (Edit)
...
public:
	...
	uint32_t                                           bUseRootMotionVelocity : 1;                               // 0x0590(0x0004) (Edit)
	uint32_t                                           bAllowSkeletonUpdateChangeBasedOnTickResult : 1;          // 0x0590(0x0004) (Edit)
	uint32_t                                           bTickWhenNotVisible : 1;                                  // 0x0590(0x0004) (Edit)
	uint32_t                                           bIsPlayingIdleAnimation : 1;                              // 0x0590(0x0004)
	uint32_t                                           bIsPlayingDeathAnimation : 1;                             // 0x0590(0x0004)
	uint32_t                                           bIsPlayingImportantAnimation : 1;                         // 0x0590(0x0004)
	uint32_t                                           bAnimateThisTick : 1;                                     // 0x0590(0x0004)
...
public:
	...
	uint32_t                                           bIdleBehavior : 1;                                        // 0x0064(0x0004) (Edit)
	uint32_t                                           bFaceActionTargetFirst : 1;                               // 0x0064(0x0004) (Edit)
	uint32_t                                           bIsViralBehavior : 1;                                     // 0x0064(0x0004) (Edit)
	uint32_t                                           bPassOnIsViralBehaviorFlag : 1;                           // 0x0064(0x0004) (Edit)
...
public:
	...
	uint32_t                                           bUseRootMotion : 1;                                       // 0x00AC(0x0004) (Edit)
	uint32_t                                           bLookAtPlayer : 1;                                        // 0x00AC(0x0004) (Edit)
	uint32_t                                           bLooping : 1;                                             // 0x00AC(0x0004) (Edit)
	uint32_t                                           bBlendBetweenAnims : 1;                                   // 0x00AC(0x0004) (Edit)
...
{
public:
	uint32_t                                           bStoppingBehavior : 1;                                    // 0x0094(0x0004)
...
{
public:
	uint32_t                                           bIsEnabled : 1;                                           // 0x026C(0x0004) (Edit, Net)
...
public:
	...
	uint32_t                                           bRequireLOS : 1;                                          // 0x0284(0x0004) (Edit)
...
public:
	...
	uint32_t                                           bKillWhenReached : 1;                                     // 0x0280(0x0004) (Edit)
	uint32_t                                           bAllowAsPreviousDestination : 1;                          // 0x0280(0x0004) (Edit)
	uint32_t                                           bAvoidWhenPanicked : 1;                                   // 0x0280(0x0004) (Edit)
	uint32_t                                           bSkipBehaviorIfPanicked : 1;                              // 0x0280(0x0004) (Edit)
	uint32_t                                           bFleeDestination : 1;                                     // 0x0280(0x0004) (Edit)
	uint32_t                                           bMustReachExactly : 1;                                    // 0x0280(0x0004) (Edit)
	uint32_t                                           bHasRestrictions : 1;                                     // 0x0280(0x0004)
	uint32_t                                           bAllowsSpawning : 1;                                      // 0x0280(0x0004) (Edit)
	uint32_t                                           bAllowCloudSpawning : 1;                                  // 0x0280(0x0004) (Edit)
	uint32_t                                           bAllowVisibleSpawning : 1;                                // 0x0280(0x0004) (Edit)
	uint32_t                                           bLineSpawner : 1;                                         // 0x0280(0x0004) (Edit)
	uint32_t                                           bSpawnAtEdge : 1;                                         // 0x0280(0x0004) (Edit)
	uint32_t                                           bSoftPerimeter : 1;                                       // 0x0280(0x0004) (Edit)
	uint32_t                                           bIsVisible : 1;                                           // 0x0280(0x0004)
	uint32_t                                           bWillBeVisible : 1;                                       // 0x0280(0x0004)
	uint32_t                                           bCanSpawnHereNow : 1;                                     // 0x0280(0x0004)
	uint32_t                                           bIsBeyondSpawnDistance : 1;                               // 0x0280(0x0004)
	uint32_t                                           bAdjacentToVisibleNode : 1;                               // 0x0280(0x0004)
	uint32_t                                           bHasNavigationMesh : 1;                                   // 0x0280(0x0004)
...
public:
	...
	uint32_t                                           bClearingQueue : 1;                                       // 0x0298(0x0004)
	uint32_t                                           bPendingAdvance : 1;                                      // 0x0298(0x0004)
...
public:
	...
	uint32_t                                           bDebugSpawns : 1;                                         // 0x0364(0x0004) (Edit)
	uint32_t                                           bPauseCrowd : 1;                                          // 0x0364(0x0004) (Edit)
...
public:
	...
	uint32_t                                           bSpawningActive : 1;                                      // 0x0274(0x0004) (Net)
...
{
public:
	uint32_t                                           bDirectionalExplosion : 1;                                // 0x0058(0x0004) (Edit)
	uint32_t                                           bIgnoreInstigator : 1;                                    // 0x0058(0x0004) (Transient)
	uint32_t                                           bAllowTeammateCringes : 1;                                // 0x0058(0x0004) (Edit)
	uint32_t                                           bFullDamageToAttachee : 1;                                // 0x0058(0x0004) (Transient)
	uint32_t                                           bAttachExplosionEmitterToAttachee : 1;                    // 0x0058(0x0004) (Edit)
	uint32_t                                           bPerformRadialBlurRelevanceCheck : 1;                     // 0x0058(0x0004) (Edit)
	uint32_t                                           bCausesFracture : 1;                                      // 0x0058(0x0004) (Edit)
	uint32_t                                           bAllowPerMaterialFX : 1;                                  // 0x0058(0x0004) (Edit)
	uint32_t                                           bParticleSystemIsBeingOverriddenDontUsePhysMatVersion : 1;// 0x0058(0x0004) (Edit)
	uint32_t                                           bSkipDefaultPhysMatParticleSystem : 1;                    // 0x0058(0x0004) (Edit)
	uint32_t                                           bUseMapSpecificValues : 1;                                // 0x0058(0x0004) (Edit)
	uint32_t                                           bUseOverlapCheck : 1;                                     // 0x0058(0x0004) (Edit)
	uint32_t                                           bOrientCameraShakeTowardsEpicenter : 1;                   // 0x0058(0x0004) (Edit)
	uint32_t                                           bAutoControllerVibration : 1;                             // 0x0058(0x0004) (Edit)
...
{
public:
	uint32_t                                           bHasExploded : 1;                                         // 0x026C(0x0004) (Transient)
	uint32_t                                           bExplodeMoreThanOnce : 1;                                 // 0x026C(0x0004) (Edit)
	uint32_t                                           bTrackExplosionParticleSystemLifespan : 1;                // 0x026C(0x0004)
	uint32_t                                           bDrawDebug : 1;                                           // 0x026C(0x0004)
...
{
public:
	uint32_t                                           bLastHitWasHeadShot : 1;                                  // 0x0580(0x0004) (Net, Transient)
	uint32_t                                           bRespondToExplosions : 1;                                 // 0x0580(0x0004)
...
public:
	...
	uint32_t                                           bShowSelectedInfo : 1;                                    // 0x07A0(0x0004) (Config, GlobalConfig)
	uint32_t                                           bDrawDebugText : 1;                                       // 0x07A0(0x0004)
	uint32_t                                           bIsFrozenRendering : 1;                                   // 0x07A0(0x0004)
...
{
public:
	uint32_t                                           bShowGameHud : 1;                                         // 0x058C(0x0004) (Config)
	uint32_t                                           bShowMobileHud : 1;                                       // 0x058C(0x0004) (Config)
	uint32_t                                           bForceMobileHUD : 1;                                      // 0x058C(0x0004) (Config, GlobalConfig)
	uint32_t                                           bShowMobileTilt : 1;                                      // 0x058C(0x0004) (Config)
	uint32_t                                           bDebugTouches : 1;                                        // 0x058C(0x0004) (Config)
	uint32_t                                           bDebugZones : 1;                                          // 0x058C(0x0004) (Config)
	uint32_t                                           bDebugZonePresses : 1;                                    // 0x058C(0x0004) (Config)
	uint32_t                                           bShowMotionDebug : 1;                                     // 0x058C(0x0004) (Config)
...
public:
	...
	uint32_t                                           bScalePawnMovement : 1;                                   // 0x00A0(0x0004) (Edit, Config)
	uint32_t                                           bRelativeX : 1;                                           // 0x00A0(0x0004) (Edit, Config)
	uint32_t                                           bRelativeY : 1;                                           // 0x00A0(0x0004) (Edit, Config)
	uint32_t                                           bRelativeSizeX : 1;                                       // 0x00A0(0x0004) (Edit, Config)
	uint32_t                                           bRelativeSizeY : 1;                                       // 0x00A0(0x0004) (Edit, Config)
	uint32_t                                           bActiveSizeYFromX : 1;                                    // 0x00A0(0x0004) (Edit, Config)
	uint32_t                                           bSizeYFromSizeX : 1;                                      // 0x00A0(0x0004) (Edit, Config)
	uint32_t                                           bApplyGlobalScaleToActiveSizes : 1;                       // 0x00A0(0x0004) (Edit, Config)
	uint32_t                                           bCenterX : 1;                                             // 0x00A0(0x0004) (Edit, Config)
	uint32_t                                           bCenterY : 1;                                             // 0x00A0(0x0004) (Edit, Config)
	uint32_t                                           bIsInvisible : 1;                                         // 0x00A0(0x0004) (Edit, Config)
	uint32_t                                           bQuickDoubleTap : 1;                                      // 0x00A0(0x0004) (Edit, Config)
	uint32_t                                           bCenterOnEvent : 1;                                       // 0x00A0(0x0004) (Edit, Config)
	uint32_t                                           bSliderHasTrack : 1;                                      // 0x00A0(0x0004) (Edit, Config)
	uint32_t                                           bFloatingTiltZone : 1;                                    // 0x00A0(0x0004) (Edit, Config)
	uint32_t                                           bUseGentleTransitions : 1;                                // 0x00A0(0x0004) (Edit, Config)
	uint32_t                                           bAllowFirstDeltaForTrackballZone : 1;                     // 0x00A0(0x0004) (Edit, Config)
	uint32_t                                           bRenderGuides : 1;                                        // 0x00A0(0x0004) (Edit, Config)
	uint32_t                                           bIsDoubleTapAndHold : 1;                                  // 0x00A0(0x0004)
	...
	struct FScriptDelegate                             __OnProcessInputDelegate__Delegate;                       // 0x01F8(0x000C) (NeedCtorLink)
	unsigned char                                      UnknownData00[0x4];                                       // 0x01F8(0x0004) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	struct FScriptDelegate                             __OnTapDelegate__Delegate;                                // 0x0208(0x000C) (NeedCtorLink)
	unsigned char                                      UnknownData01[0x4];                                       // 0x0208(0x0004) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	struct FScriptDelegate                             __OnDoubleTapDelegate__Delegate;                          // 0x0218(0x000C) (NeedCtorLink)
	unsigned char                                      UnknownData02[0x4];                                       // 0x0218(0x0004) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	struct FScriptDelegate                             __OnProcessSlide__Delegate;                               // 0x0228(0x000C) (NeedCtorLink)
	unsigned char                                      UnknownData03[0x4];                                       // 0x0228(0x0004) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	struct FScriptDelegate                             __OnPreDrawZone__Delegate;                                // 0x0238(0x000C) (NeedCtorLink)
	unsigned char                                      UnknownData04[0x4];                                       // 0x0238(0x0004) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	struct FScriptDelegate                             __OnPostDrawZone__Delegate;                               // 0x0248(0x000C) (NeedCtorLink)
...
{
public:
	uint32_t                                           bHasBeenInitialized : 1;                                  // 0x0058(0x0004) (Transient)
	uint32_t                                           bRelativeLeft : 1;                                        // 0x0058(0x0004)
	uint32_t                                           bRelativeTop : 1;                                         // 0x0058(0x0004)
	uint32_t                                           bRelativeWidth : 1;                                       // 0x0058(0x0004)
	uint32_t                                           bRelativeHeight : 1;                                      // 0x0058(0x0004)
	uint32_t                                           bApplyGlobalScaleLeft : 1;                                // 0x0058(0x0004)
	uint32_t                                           bApplyGlobalScaleTop : 1;                                 // 0x0058(0x0004)
	uint32_t                                           bApplyGlobalScaleWidth : 1;                               // 0x0058(0x0004)
	uint32_t                                           bApplyGlobalScaleHeight : 1;                              // 0x0058(0x0004)
	uint32_t                                           bHeightRelativeToWidth : 1;                               // 0x0058(0x0004)
	uint32_t                                           bXOffsetIsActual : 1;                                     // 0x0058(0x0004)
	uint32_t                                           bYOffsetIsActual : 1;                                     // 0x0058(0x0004)
	uint32_t                                           bIsActive : 1;                                            // 0x0058(0x0004)
	uint32_t                                           bIsHidden : 1;                                            // 0x0058(0x0004)
	uint32_t                                           bIsTouched : 1;                                           // 0x0058(0x0004)
	uint32_t                                           bIsHighlighted : 1;                                       // 0x0058(0x0004)
	uint32_t                                           bTellSceneBeforeRendering : 1;                            // 0x0058(0x0004)
...
public:
	...
	uint32_t                                           bSceneDoesNotRequireInput : 1;                            // 0x0088(0x0004) (Edit)
	uint32_t                                           bRelativeLeft : 1;                                        // 0x0088(0x0004) (Edit)
	uint32_t                                           bRelativeTop : 1;                                         // 0x0088(0x0004) (Edit)
	uint32_t                                           bRelativeWidth : 1;                                       // 0x0088(0x0004) (Edit)
	uint32_t                                           bRelativeHeight : 1;                                      // 0x0088(0x0004) (Edit)
	uint32_t                                           bApplyGlobalScaleLeft : 1;                                // 0x0088(0x0004) (Edit)
	uint32_t                                           bApplyGlobalScaleTop : 1;                                 // 0x0088(0x0004) (Edit)
	uint32_t                                           bApplyGlobalScaleWidth : 1;                               // 0x0088(0x0004) (Edit)
	uint32_t                                           bApplyGlobalScaleHeight : 1;                              // 0x0088(0x0004) (Edit)
...
public:
	...
	uint32_t                                           bAllowTouchesInCinematic : 1;                             // 0x04B8(0x0004) (Edit)
	uint32_t                                           bDisableTouchInput : 1;                                   // 0x04B8(0x0004) (Edit)
	uint32_t                                           bAbsoluteTouchLocations : 1;                              // 0x04B8(0x0004) (Edit, Config)
	uint32_t                                           bCollapseTouchInput : 1;                                  // 0x04B8(0x0004) (Edit, Config)
	uint32_t                                           bFakeMobileTouches : 1;                                   // 0x04B8(0x0004) (Edit)
	uint32_t                                           bDisableSceneRender : 1;                                  // 0x04B8(0x0004) (Edit)
	...
	struct FScriptDelegate                             __OnTouchNotHandledInMenu__Delegate;                      // 0x051C(0x000C) (NeedCtorLink)
	unsigned char                                      UnknownData00[0x4];                                       // 0x051C(0x0004) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	struct FScriptDelegate                             __OnPreviewTouch__Delegate;                               // 0x052C(0x000C) (NeedCtorLink)
	unsigned char                                      UnknownData01[0x4];                                       // 0x052C(0x0004) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	struct FScriptDelegate                             __OnInputTouch__Delegate;                                 // 0x053C(0x000C) (NeedCtorLink)
...
public:
	...
	uint32_t                                           bShowDebug : 1;                                           // 0x0088(0x0004)
...
public:
	...
	uint32_t                                           bClearOldArchetypes : 1;                                  // 0x0164(0x0004) (Edit)
	uint32_t                                           bEnableCrowdLightEnvironment : 1;                         // 0x0164(0x0004) (Edit)
	uint32_t                                           bCastShadows : 1;                                         // 0x0164(0x0004) (Edit)
	uint32_t                                           bFillPotentialSpawnPoints : 1;                            // 0x0164(0x0004)
	uint32_t                                           bForceObstacleChecking : 1;                               // 0x0164(0x0004) (Edit)
	uint32_t                                           bForceNavMeshPathing : 1;                                 // 0x0164(0x0004) (Edit)
	uint32_t                                           bIndividualSpawner : 1;                                   // 0x0164(0x0004)
...
public:
	...
	uint32_t                                           bUseRootMotion : 1;                                       // 0x0188(0x0004) (Edit)
	uint32_t                                           bFaceActionTargetFirst : 1;                               // 0x0188(0x0004) (Edit)
	uint32_t                                           bLooping : 1;                                             // 0x0188(0x0004) (Edit)
	uint32_t                                           bBlendBetweenAnims : 1;                                   // 0x0188(0x0004) (Edit)
...
public:
	...
	uint32_t                                           bIsActive : 1;                                            // 0x0178(0x0004) (Edit)
...
{
public:
	uint32_t                                           bWasActiveLastFrame : 1;                                  // 0x0178(0x0004)
	uint32_t                                           bSendPressedOnlyOnTouchDown : 1;                          // 0x0178(0x0004) (Edit)
	uint32_t                                           bSendPressedOnlyOnTouchUp : 1;                            // 0x0178(0x0004) (Edit)
...
public:
	...
	uint32_t                                           bCheckonTouch : 1;                                        // 0x0180(0x0004) (Edit)
...
{
public:
	uint32_t                                           bBoneSpaceRecoil : 1;                                     // 0x00EC(0x0004) (Edit)
	uint32_t                                           bPlayRecoil : 1;                                          // 0x00EC(0x0004) (Edit, Transient)
	uint32_t                                           bOldPlayRecoil : 1;                                       // 0x00EC(0x0004) (Transient)
	uint32_t                                           bApplyControl : 1;                                        // 0x00EC(0x0004) (Transient)
...
public:
	...
	uint32_t                                           bResetCameraInterpolation : 1;                            // 0x0060(0x0004) (Transient)
...
public:
	...
	uint32_t                                           bFocusPointSet : 1;                                       // 0x0158(0x0004)
	uint32_t                                           bFocusPointSuccessful : 1;                                // 0x0158(0x0004) (Transient)
	uint32_t                                           bDoingACameraTurn : 1;                                    // 0x0158(0x0004)
	uint32_t                                           bTurnAlignTargetWhenFinished : 1;                         // 0x0158(0x0004)
	uint32_t                                           bDrawDebug : 1;                                           // 0x0158(0x0004) (Edit)
	uint32_t                                           bDoingDirectLook : 1;                                     // 0x0158(0x0004) (Transient)
	uint32_t                                           bDebugChangedCameraMode : 1;                              // 0x0158(0x0004) (Edit)
	uint32_t                                           bDoSeamlessPivotTransition : 1;                           // 0x0158(0x0004) (Transient)
...
public:
	...
	uint32_t                                           bUseForcedCamFOV : 1;                                     // 0x05F4(0x0004) (Transient)
	uint32_t                                           bInterpolateCamChanges : 1;                               // 0x05F4(0x0004) (Transient)
	uint32_t                                           bResetInterp : 1;                                         // 0x05F4(0x0004) (Transient)
...
public:
	...
	uint32_t                                           bLockedToViewTarget : 1;                                  // 0x0068(0x0004) (Edit, Const)
	uint32_t                                           bDirectLook : 1;                                          // 0x0068(0x0004) (Edit, Const)
	uint32_t                                           bFollowTarget : 1;                                        // 0x0068(0x0004) (Edit, Const)
	uint32_t                                           bInterpLocation : 1;                                      // 0x0068(0x0004) (Edit)
	uint32_t                                           bUsePerAxisOriginLocInterp : 1;                           // 0x0068(0x0004) (Edit)
	uint32_t                                           bInterpRotation : 1;                                      // 0x0068(0x0004) (Edit)
	uint32_t                                           bRotInterpSpeedConstant : 1;                              // 0x0068(0x0004) (Edit)
	uint32_t                                           bDoPredictiveAvoidance : 1;                               // 0x0068(0x0004) (Edit, Const)
	uint32_t                                           bValidateWorstLoc : 1;                                    // 0x0068(0x0004) (Edit, Const)
	uint32_t                                           bSkipCameraCollision : 1;                                 // 0x0068(0x0004) (Edit)
	uint32_t                                           bSmoothViewOffsetPitchChanges : 1;                        // 0x0068(0x0004) (Edit, Const)
	uint32_t                                           bApplyDeltaViewOffset : 1;                                // 0x0068(0x0004) (Edit)
	uint32_t                                           bAdjustDOF : 1;                                           // 0x0068(0x0004) (Edit, Const)
	uint32_t                                           bDOFUpdated : 1;                                          // 0x0068(0x0004) (Transient)
	uint32_t                                           bNoFOVPostProcess : 1;                                    // 0x0068(0x0004)
	uint32_t                                           bInterpViewOffsetOnlyForCamTransition : 1;                // 0x0068(0x0004) (Edit)
...
public:
	...
	uint32_t                                           bTemporaryOriginRotInterp : 1;                            // 0x0254(0x0004) (Transient)
...
public:
	...
	uint32_t                                           bLastCanDoSpecialMove : 1;                                // 0x006C(0x0004)
	uint32_t                                           bReachPreciseDestination : 1;                             // 0x006C(0x0004) (Const)
	uint32_t                                           bReachedPreciseDestination : 1;                           // 0x006C(0x0004) (Const)
	uint32_t                                           bReachPreciseRotation : 1;                                // 0x006C(0x0004) (Const)
	uint32_t                                           bReachedPreciseRotation : 1;                              // 0x006C(0x0004) (Const)
	uint32_t                                           bForcePrecisePosition : 1;                                // 0x006C(0x0004)
...
public:
	...
	uint32_t                                           bIsMatchStarted : 1;                                      // 0x00A4(0x0004)
	uint32_t                                           bIsRoundStarted : 1;                                      // 0x00A4(0x0004)
...
{
public:
	uint32_t                                           bDrawDebugText : 1;                                       // 0x058C(0x0004)
...
public:
	...
	uint32_t                                           bWasFiring : 1;                                           // 0x0098(0x0004) (Transient)
...
public:
	...
	uint32_t                                           bWasFiring : 1;                                           // 0x0088(0x0004) (Transient)
	uint32_t                                           bFinalApproach : 1;                                       // 0x0088(0x0004)
	uint32_t                                           bFallbackMoveToMesh : 1;                                  // 0x0088(0x0004)
...
{
public:
	uint32_t                                           bAutoControllerVibration : 1;                             // 0x0058(0x0004) (Edit, Const)
	uint32_t                                           bOrientCameraShakeTowardsEpicenter : 1;                   // 0x0058(0x0004) (Edit, Const)
...
{
public:
	uint32_t                                           bDrawDebugText : 1;                                       // 0x06A8(0x0004)
...
{
public:
	uint32_t                                           bIsVertical : 1;                                          // 0x00D4(0x0004) (Edit)
	uint32_t                                           bDirty : 1;                                               // 0x00D4(0x0004)
...
public:
	...
	uint32_t                                           bIsVisible : 1;                                           // 0x0068(0x0004)
	uint32_t                                           bIsActive : 1;                                            // 0x0068(0x0004)
...
public:
	...
	uint32_t                                           bRenderDragItem : 1;                                      // 0x0130(0x0004)
	uint32_t                                           bInitialzed : 1;                                          // 0x0130(0x0004)
	struct FScriptDelegate                             __OnUpdateItemInSlot__Delegate;                           // 0x0134(0x000C) (NeedCtorLink)
	unsigned char                                      UnknownData00[0x4];                                       // 0x0134(0x0004) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	struct FScriptDelegate                             __DoCanPutItemInSlot__Delegate;                           // 0x0144(0x000C) (NeedCtorLink)
	unsigned char                                      UnknownData01[0x4];                                       // 0x0144(0x0004) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	struct FScriptDelegate                             __OnUpdateDrag__Delegate;                                 // 0x0154(0x000C) (NeedCtorLink)
...
public:
	...
	uint32_t                                           bAutoSize : 1;                                            // 0x00FC(0x0004)
...
{
public:
	uint32_t                                           bIsVerticalList : 1;                                      // 0x00D4(0x0004) (Edit)
	uint32_t                                           bDisableScrolling : 1;                                    // 0x00D4(0x0004) (Edit)
	uint32_t                                           bForceSelectedToLineup : 1;                               // 0x00D4(0x0004) (Edit)
	uint32_t                                           bTapToScrollToItem : 1;                                   // 0x00D4(0x0004)
	uint32_t                                           bLoops : 1;                                               // 0x00D4(0x0004)
...
{
public:
	struct FScriptDelegate                             __OnTouchEvent__Delegate;                                 // 0x00D4(0x000C) (NeedCtorLink)
	unsigned char                                      UnknownData00[0x4];                                       // 0x00D4(0x0004) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	struct FScriptDelegate                             __OnRenderObject__Delegate;                               // 0x00E4(0x000C) (NeedCtorLink)
...
{
public:
	uint32_t                                           bEnabled : 1;                                             // 0x02A8(0x0004)
