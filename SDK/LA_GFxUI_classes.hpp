...
public:
	...
	uint32_t                                           bFakeMobileTouches : 1;                                   // 0x00B0(0x0004)
...
public:
	...
	uint32_t                                           bMovieIsOpen : 1;                                         // 0x010C(0x0004) (Const)
	uint32_t                                           bDisplayWithHudOff : 1;                                   // 0x010C(0x0004)
	uint32_t                                           bEnableGammaCorrection : 1;                               // 0x010C(0x0004)
	uint32_t                                           bWidgetsInitializedThisFrame : 1;                         // 0x010C(0x0004) (Const, Transient)
	uint32_t                                           bLogUnhandedWidgetInitializations : 1;                    // 0x010C(0x0004)
	uint32_t                                           bAllowInput : 1;                                          // 0x010C(0x0004)
	uint32_t                                           bAllowFocus : 1;                                          // 0x010C(0x0004)
	uint32_t                                           bAutoPlay : 1;                                            // 0x010C(0x0004)
	uint32_t                                           bPauseGameWhileActive : 1;                                // 0x010C(0x0004)
	uint32_t                                           bDisableWorldRendering : 1;                               // 0x010C(0x0004)
	uint32_t                                           bCaptureWorldRendering : 1;                               // 0x010C(0x0004)
	uint32_t                                           bCloseOnLevelChange : 1;                                  // 0x010C(0x0004)
	uint32_t                                           bOnlyOwnerFocusable : 1;                                  // 0x010C(0x0004)
	uint32_t                                           bForceFullViewport : 1;                                   // 0x010C(0x0004)
	uint32_t                                           bDiscardNonOwnerInput : 1;                                // 0x010C(0x0004)
	uint32_t                                           bCaptureInput : 1;                                        // 0x010C(0x0004)
	uint32_t                                           bCaptureMouseInput : 1;                                   // 0x010C(0x0004)
	uint32_t                                           bIgnoreMouseInput : 1;                                    // 0x010C(0x0004)
	uint32_t                                           bIsSplitscreenLayoutModified : 1;                         // 0x010C(0x0004) (Transient)
	uint32_t                                           bShowHardwareMouseCursor : 1;                             // 0x010C(0x0004)
	uint32_t                                           bBlurLesserMovies : 1;                                    // 0x010C(0x0004)
	uint32_t                                           bHideLesserMovies : 1;                                    // 0x010C(0x0004)
	uint32_t                                           bIsPriorityBlurred : 1;                                   // 0x010C(0x0004)
	uint32_t                                           bIsPriorityHidden : 1;                                    // 0x010C(0x0004)
	uint32_t                                           bIgnoreVisibilityEffect : 1;                              // 0x010C(0x0004)
	uint32_t                                           bIgnoreBlurEffect : 1;                                    // 0x010C(0x0004)
	...
	struct FScriptDelegate                             __OnPostAdvance__Delegate;                                // 0x01DC(0x000C) (NeedCtorLink)
...
public:
	...
	uint32_t                                           bListenExternalInterfaceCall : 1;                         // 0x00A8(0x0004)
...
{
public:
	uint32_t                                           bUsesFontlib : 1;                                         // 0x0098(0x0004) (Edit)
	uint32_t                                           bSetSRGBOnImportedTextures : 1;                           // 0x0098(0x0004) (Edit, EditConst)
	uint32_t                                           bPackTextures : 1;                                        // 0x0098(0x0004) (Edit)
	uint32_t                                           bForceSquarePacking : 1;                                  // 0x0098(0x0004) (Edit)
...
public:
	...
	uint32_t                                           bUnload : 1;                                              // 0x0160(0x0004) (Edit)
...
public:
	...
	uint32_t                                           bTakeFocus : 1;                                           // 0x0170(0x0004) (Edit)
	uint32_t                                           bCaptureInput : 1;                                        // 0x0170(0x0004) (Edit)
	uint32_t                                           bStartPaused : 1;                                         // 0x0170(0x0004) (Edit)
	uint32_t                                           bEnableGammaCorrection : 1;                               // 0x0170(0x0004)
	uint32_t                                           bDisplayWithHudOff : 1;                                   // 0x0170(0x0004) (Edit)
