...
bool UEFCameraShakePlayGroup::PreUpdateViewShake(class ACamera* InCameraOwner, float InDeltaTime, struct FVector* InPlayerLocation)
{
...
// class UGFxObject*              ClassData                      (Parm)
// bool                           bPublic                        (Parm)

void UEFGFxWidgetClassPreview::SetClassUpgradeChoiceInfo(int Index, int ClassID, const struct FString& ClassName, class UGFxObject* ClassData, bool bPublic)
{
...
void UEFGFxWidgetInteraction::SelectFunctionType(const struct FString& Type)
{
...
void UEFGFxWidgetInteraction::SelectFunctionContainer(const struct FString& Type)
{
...
// (Defined, Event, Public)
// Parameters:
// TArray<uint32_t>               Array                          (Parm, NeedCtorLink)

void UEFGFxWidgetPcCustomizing::setPreviewcostumeData(TArray<uint32_t> Array)
{
...
void UEFGFxWidgetPcCustomizing::setPresetData(TArray<uint32_t> Array)
{
